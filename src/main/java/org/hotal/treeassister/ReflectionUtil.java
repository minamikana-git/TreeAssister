...
public class ReflectionUtil {
    ...
    static {
        ...
        try {
            ...
            TreeAssister.log.log(Level.SEVERE,
    ...
    public static Object itemStackAsNmsCopy(ItemStack itemStack) {
        try {
            ...
            TreeAssister.log.log(Level.SEVERE, "Error creating NMS ItemStack", e);
        }
        return null;
    }
    ...
    public static Object craftWorldGetHandle(World world) {
        try {
            ...
            TreeAssister.log.log(Level.SEVERE, "Error getting NMS World", e);
        }
        return null;
    }
    ...
    public static Object constructBlockPosition(int x, int y, int z) {
        try {
            ...
            TreeAssister.log.log(Level.SEVERE, "Error constructing Block Position", e);
        }
        return null;
    }
    ...
    public static void applyBoneMeal(Object nmsItemStack, Object nmsWorld, Object nmsBlockPosition) {
        try {
            ...
            TreeAssister.log.log(Level.SEVERE, "Error applying bone meal!", e);
        }
    }
